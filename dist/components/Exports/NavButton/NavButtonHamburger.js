...
const NavButtonHamburger = ({ text, onClick, className }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(sharedComponents_1.StyledHamburgerNavDiv, { className: className, children: (0, jsx_runtime_1.jsx)("button", { onClick: onClickHamburger, children: text }) }));
};
