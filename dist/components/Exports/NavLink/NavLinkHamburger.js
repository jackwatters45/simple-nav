...
const NavLinkHamburger = ({ text, to, className }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(sharedComponents_1.StyledHamburgerNavDiv, { className: className, children: (0, jsx_runtime_1.jsx)(StyledLink, { onClick: onClickHamburger, to: to, children: text }) }));
};
